# AI Agent Instructions: FFC-EX-freedomrisingusa.org
...
These sites deploy to `https://freeforcharity.github.io/FFC-EX-freedomrisingusa.org/` and optionally to a custom domain if one is configured for this repo.
