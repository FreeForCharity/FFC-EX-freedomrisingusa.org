      ...
      <div className="py-[27px] w-[90%] md:w-[80%] mx-auto">
        <div id="aria-font">
          ...
          <p className="text-[14px] text-[#666] pb-[10px] leading-[24px] font-[500]">
            ...
            or (571) 257-6411 to exercise any of these rights; we will respond within the time
          ...
          <p className="text-[14px] text-[#666] pb-[10px] leading-[24px] font-[500]">
            <strong>We do not sell or share your personal information.</strong> Freedom Rising USA
          ...
          <p className="text-[14px] text-[#666] pb-[10px] leading-[24px] font-[500]">
            ...
            or (571) 257-6411. We will verify your request using information associated with your
