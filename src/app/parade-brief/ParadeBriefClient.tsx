      ...
      <div className="grid md:grid-cols-2 gap-6">
        <div className="space-y-4">
          <div className="bg-blue-50 p-4 rounded-lg">
            <h3 className="font-semibold text-lg mb-2 text-[#002868]">🎖️ Veterans & Military</h3>
            <p className="text-gray-700 text-sm">
              Active duty, veterans, and military organizations
            </p>
          </div>
          <div className="bg-blue-50 p-4 rounded-lg">
            <h3 className="font-semibold text-lg mb-2 text-[#002868]">🏫 Schools & Youth Groups</h3>
            <p className="text-gray-700 text-sm">
    ...
    content: (
      <div className="space-y-4">
        <div className="bg-yellow-50 border-l-4 border-yellow-500 p-4">
          <h3 className="font-semibold text-lg mb-2">⚠️ Important Safety Guidelines</h3>
    ...
    content: (
      <div className="space-y-6">
        <div className="text-center mb-6">
          <h3 className="text-2xl font-semibold mb-4 text-[#002868]">Join the Celebration!</h3>
          <p className="text-lg text-gray-700">We welcome all community members to participate</p>
        </div>
        <div className="grid md:grid-cols-3 gap-6">
          <div className="bg-white border-2 border-[#002868] p-6 rounded-lg text-center">
            ...
            <p className="text-gray-700 text-sm">Complete the online registration form</p>
          </div>
          <div className="bg-white border-2 border-[#002868] p-6 rounded-lg text-center">
            <div className="text-4xl mb-3">2️⃣</div>
            <h4 className="font-semibold text-lg mb-2">Prepare</h4>
            <p className="text-gray-700 text-sm">Plan your entry and gather materials</p>
          </div>
          <div className="bg-white border-2 border-[#002868] p-6 rounded-lg text-center">
            <div className="text-4xl mb-3">3️⃣</div>
            <h4 className="font-semibold text-lg mb-2">Participate</h4>
            <p className="text-gray-700 text-sm">Arrive on time and enjoy the parade!</p>
          </div>
        </div>
        <div className="bg-blue-50 p-6 rounded-lg text-center">
          <p className="text-lg font-semibold mb-2">Questions?</p>
          <p className="text-gray-700">
            Contact us at contact@freedomrisingusa.org or (571) 257-6411
          </p>
        </div>
      </div>
    ),
  ...
  },
  {
    ...
    content: (
      <div className="space-y-6">
        ...
        <div className="bg-white border-2 border-[#002868] p-6 rounded-lg text-center">
          <h4 className="font-semibold text-lg mb-3">Visit Our Website</h4>
          <Link
            href="/"
            className="inline-block bg-[#002868] text-white px-6 py-3 rounded-full hover:bg-[#001a4d] transition-colors"
          >
        ...
        <div className="text-center text-gray-600 mt-8">
          ...
          <p className="text-xl mt-4">🇺🇸 God Bless America 🇺🇸</p>
        </div>
      </div>
    ),
  },
      ...
      <div className="bg-white shadow-md mb-8">
        <div className="container mx-auto px-4 py-4 flex justify-between items-center">
          ...
          <button
            ...
            aria-label="Download or print parade brief as PDF"
          >
            <Download size={20} />
