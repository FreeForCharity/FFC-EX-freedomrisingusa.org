# Copilot Instructions: FFC-EX-freedomrisingusa.org

Free For Charity nonprofit website for freedomrisingusa.org. Next.js static site on GitHub Pages.
...
- **Content:** `src/data/` (TypeScript content modules)
- **Utilities:** `src/lib/`
