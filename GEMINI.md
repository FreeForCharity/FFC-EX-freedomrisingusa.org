# Gemini Instructions: FFC-EX-freedomrisingusa.org

Hey Gemini! Welcome to FFC-EX-freedomrisingusa.org.

**Project:** FFC-EX-freedomrisingusa.org -- a Free For Charity nonprofit website for freedomrisingusa.org
...
The site deploys to `https://freeforcharity.github.io/FFC-EX-freedomrisingusa.org/` (and your custom domain if configured). The `assetPath()` function from `src/lib/assetPath.ts` handles this automatically.
